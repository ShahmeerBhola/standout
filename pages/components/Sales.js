    ...
    <div className="bg-light  py-[65px] ">
      <div className="w-10/12 mx-auto">
        ...
        <div className="flex flex-row pt-[50px] gap-3 w-10/12 mx-auto">
            {/* Product1 */}
          <div className=" flex group group1 flex-col p-3 gap-3  w-1/4 border rounded-md relative overflow-hidden">
          ...
          {/* Product2 */}
          <div className=" flex group group1 flex-col p-3 gap-5  w-1/4 border rounded-md relative overflow-hidden">
            <AiOutlineStar className="absolute right-4 text-[#eccb1d] text-lg" />
