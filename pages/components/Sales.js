    ...
    <div className="bg-light  py-[65px] overflow-hidden ">
      <div className="w-10/12 mx-auto">
        <div className=" flex flex-col gap-3 justify-center !text-center ">
          <h2 className="text-4xl font-bold">Sale Products</h2>
        ...
        <div className="grid md:grid-cols-2 mmd:grid-cols-3 lg:!grid-cols-4  pt-[50px] gap-3 w-10/12 mx-auto mmd:mx-0 mmd:w-full ">
            {/* Product1 */}
          <div className=" flex group group1 flex-col p-3 gap-3  w-full border rounded-md relative overflow-hidden">
          ...
          {/* Product2 */}
          <div className=" flex group group1 flex-col p-3 gap-5  w-full border rounded-md relative overflow-hidden">
            <AiOutlineStar className="absolute right-4 text-[#eccb1d] text-lg" />
