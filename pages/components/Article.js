      ...
      <div className="w-10/12 mx-auto">
        ...
        <CardSlider type="3">
           ...
           <div className=" flex group group1 flex-col p-4 bg-white  gap-3  w-[400px] border rounded-xl relative overflow-hidden">
            <img className="h-[160px] " src="/Images/news2.png"/>
          ...
          {/* Product2 */}
          <div className=" flex group group1 flex-col p-4 bg-white  gap-3  w-[400px] border rounded-xl relative overflow-hidden">
            <img className="h-[160px] " src="/Images/news3.png"/>
        ...
        {/* </div> */}
        <div className="mt-[140px] grid grid-rows-2 grid-flow-col border px-5 py-3 rounded-xl">
