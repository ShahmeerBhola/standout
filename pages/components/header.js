...
function header() {
  return (
    <div className="w-full h-full overflow-hidden">
      <div className="w-11/12 md:w-10/12 gap-3 md:gap-0 flex flex-col justify-center md:flex-row text-xs mx-auto py-3 ">
      ...
      {/* responsive menu */}
      <div className="w-11/12 md:w-10/12 flex mx-auto justify-between py-4 items-center">
